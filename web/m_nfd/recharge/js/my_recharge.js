...
var g_single_min = 200; /*单笔最低金额*/
var g_single_max = 50000; /*单笔最高限额*/

var g_day_max = 50000; /*当日最高限额*/
var g_month_max = 200000; /*当月最高限额*/

var g_day_amt = 40000; //当日充值累计
var g_month_amt = 195000; //当月充值累计

var g_day_rest = 10000; //当日剩余额度
var g_month_rest = 5000; //当月剩余额度
...
$(function() {
	$("#rechargeBtn").click(sureRecharge);
	$.ajax({
		type: "GET",
		...
		success: function(data) {
			if (data) {
				...
				if (bankValue) {
					...
					var dr_value = parseFloat(datai['F007']);
