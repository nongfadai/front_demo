<div class="wx_register wx_pdb50" id="wxRegister">
  <div class="register-form1">
    <form action='#' onsubmit="return false" method="post" name="pageform" id="pageform">
      <input type="hidden" value="" name="refferee_source" id="refferee_source" />
      ...
      <div class="input-box">
        ...
        <input class='input-text register-password' type='text' maxlength="20" name="password" id="password" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" placeholder="请设置登录密码" />
        <div class="input-tip"></div>
        <span class="input-pass-hide">隐藏</span> </div>
      <div class="wx_tip" style="display:none;"></div>
      <div class="input-box">
      ...
      <div class="input-btn"> <a href="javascript:void(0);" class='wx_btn_org' id="step_one">下一步</a> </div>
      <div class="input-check">
        <input type='checkbox' id='agree' name='agree' checked style="display:none;">
        <span class="input-check-img input-checked-img"></span> 我已阅读并同意<a href="terms.html" class="wx_blue" id="wxTerms"> 《使用条款》</a>和<a href="terms_privacy.html" class="wx_blue"  id="wxTermsPrivacy">《隐私条款》</a> </div>
    </form>
  </div>
  <div class="register-form2" style="display:none;">
    ...
    <form action='#' onsubmit="return false" method="post" name="pageform" id="pageform2">
      <div class="input-box code-box">
        ...
        <a href="javascript:void(0);" class="wx_btn_blue code-btn" id="reSend" left_time_int="60">重发短信</a> </div>
