...
<form action='#' onsubmit="return false" method="post" name="pageform" id="pageform">
    ...
    <div class="input-check">
      ...
      <span class="input-check-img input-checked-img"></span> 我已阅读并同意<a href="../../weixin_copy/tpl/terms.html" class="wx_blue" id="wxTerms"> 《使用条款》</a>和<a href="../../weixin_copy/tpl/terms_privacy.html" class="wx_blue"  id="wxTermsPrivacy">《隐私条款》</a>
  	</div>
</form>
</div>
...
<div class="wx_register-ok" id="registerOK"  style="display:none">
	...
	<a href="../../weixin_copy/tpl/list.html#axn" class="wx_btn_org">浏览产品列表 (<span id="registerOkCountdown" left_time_int="5">5</span>)</a>
